...
详细说明见 [Windows/README.md](Windows/README.md)。稳定的 `v1.1.6` Release 仍以源码为主；`v1.1.6-binary-preview.3` 提供 macOS DMG/ZIP 与 Windows 安装器，均为未公证或未受平台发行者信任的实验二进制，不提供自动更新或官方安装支持。
